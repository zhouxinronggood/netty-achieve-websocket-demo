...
import com.example.springbootwebsocketdemo.constant.MessageTypeEnum;
import com.example.springbootwebsocketdemo.entity.HeartbeatMessage;
import com.example.springbootwebsocketdemo.entity.RegisterMessage;
import com.example.springbootwebsocketdemo.entity.TextMessage;
...
/**
 * @Description 消息服务处理器
 * @ChannelHandler.Sharable 目的以单例的形式存在了，但实际上没啥作用，所以不能使用@Sharable注解
 * @Author zhouxinrong
 * @Date 2023/7/30
 * @Version 1.0
 */
...
public class WebSocketServerHandler extends SimpleChannelInboundHandler<TextWebSocketFrame> {
    ...
    public WebSocketServerHandler() {
        log.debug("WebSocketServerHandler 启动...");
    }
